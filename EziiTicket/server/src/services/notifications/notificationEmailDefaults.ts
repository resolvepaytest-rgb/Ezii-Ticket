/**
 * Server-side defaults when no row exists in `notification_templates`.
 * Keep copy aligned with `client/src/pages/admin/notificationTemplateDefaults.ts` for `team_lead_no_assignee`.
 */
...
const teamLeadInner = `<p style="margin:0 0 16px;font-size:16px;font-weight:700;color:#0f172a;">Hi {{recipient_name}},</p>
