  ...
  return (
    <div className="mx-auto max-w-[1300px] min-w-0 space-y-4 pb-8">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-100">Admin Audit Log</h1>
      ...
      <div className="ml-auto max-w-sm rounded-2xl border border-black/10 bg-white/75 px-4 py-3 shadow-sm dark:border-white/10 dark:bg-white/[0.05]">
        <div className="text-sm font-semibold text-slate-800 dark:text-slate-100">Ledger Integrity: Verified</div>
        <div className="mt-1 text-xs text-slate-500 dark:text-slate-400">
          Cryptographic hash chain is intact. No unauthorized modifications detected in the last 24 hours.
        </div>
        <button className="mt-2 text-[11px] font-semibold text-[#1E88E5]">VALIDATE NOW</button>
      </div>
    </div>
  );
}
