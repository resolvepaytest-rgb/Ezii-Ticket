export const SCREEN_KEYS = [
  ...
  "webhooks",
  "audit_logs",
  /** Agent shell (see `etsNavigation` agent nav) — Roles UI group “Team/Agent”. */
  "agent_dashboard",
  "agent_my_tickets",
  "agent_team_queue",
  "agent_history",
...
export type ScreenAccessMap = Partial<Record<ScreenKey, ScreenAccessEntry>>;
...
export type ActionAccessMap = Partial<Record<ActionKey, boolean>> & Record<string, boolean>;
